...
var grammar = {
    ...
    {"name": "BasicStatement", "symbols": ["PlainVariable", "Space", "BasicStatement$ebnf$1", "Space", "BasicStatement$ebnf$2"], "postprocess":  function ([pv, sp1, colon, sp2, var1], _, result) { return {
        	type:"function",
        	name: pv,
        	arg: var1,
        	loc: _
    ...
    {"name": "Float", "symbols": ["Integer", {"literal":".","pos":150}, "Float$ebnf$1"], "postprocess": ([num1, dot, num2]) => num1 + dot + num2.join('')},
    {"name": "Integer$ebnf$1", "symbols": [{"literal":"-","pos":161}], "postprocess": id},
    ...
    {"name": "Integer$ebnf$2", "symbols": [{"literal":"-","pos":170}], "postprocess": id},
    ...
    {"name": "Zero", "symbols": [{"literal":"0","pos":186}]},
    ...
    {"name": "ObjectLeftBrace", "symbols": [{"literal":"{","pos":242}]},
    {"name": "ObjectRightBrace", "symbols": [{"literal":"}","pos":248}]},
    {"name": "EOLPIPE", "symbols": ["EOL"]},
    {"name": "EOLPIPE", "symbols": ["PIPE"], "postprocess": function(d) {return null }},
    {"name": "PIPE", "symbols": [{"literal":"|","pos":266}]},
    {"name": "DOT", "symbols": [{"literal":".","pos":272}]},
    {"name": "QUOTE", "symbols": [{"literal":"\"","pos":278}]},
